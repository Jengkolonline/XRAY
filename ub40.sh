...
CDNF="https://raw.githubusercontent.com/Jengkolonline/XRAY/main/"
...
function tambahan(){
    ...
    # > Pasang BBR Plus
    wget -qO /tmp/bbr.sh "${REPO}foldder/server/bbr.sh" >/dev/null 2>&1
...
"
    ...
    echo "    │   - Trojan None Ws          : 80                    │"
    echo "    │   - Trojan WS               : 443                   │"
    echo "    │   - Shadowsocks WS          : 443                   │"
    echo "    │   - Shadowsocks None        : 80                    │"
    echo "    │   - Shadowsocks gRPC        : 443                   │"
    echo "    │   - Shadowsocks2022 WS      : 443                   │"
    echo "    │   - Shadowsocks2022 None    : 80                    │"
    echo "    │   - Shadowsocks2022 gRPC    : 443                   │"
    echo "    │   - Socks WS                : 443                   │"
    echo "    │   - Socks None              : 80                    │"
    echo "    │   - Socks gRPC              : 443                   │"
    echo "    │   - HTTP                    : 80,2052,2082,2086,2095,8080,8880               │"
    echo "    │   - HTTPS                   : 443,2053,2083,2087,2096,8443                   │"
    echo "    │                                                     │"
