...
function download_config() {
    ...
    wget -O /etc/nginx/conf.d/xray.conf "${GITHUB_CMD}main/foldder/nginx/X-ray.conf" >/dev/null 2>&1
...
"
    ...
    echo "    │   - OpenVPN Websocket SSL   : 443                   │"
    echo "    │   - XRAY Vmess TLS          : 443, 2053, 2083       │"
    echo "    │   - XRAY Vmess gRPC         : 443, 2053, 2083       │"
    echo "    │   - XRAY Vmess None TLS     : 80, 8080, 8880        |"
    echo "    │   - XRAY Vless TLS          : 443, 2053, 2083       │"
    echo "    │   - XRAY Vless gRPC         : 443, 2053, 2083       │"
    echo "    │   - XRAY Vless None TLS     : 80, 8080, 8880        |"
    echo "    │   - Trojan gRPC             : 443, 2053, 2083       │"
    echo "    |   - Trojan None TLS         : 80, 8080, 8880        |"
    echo "    │   - Trojan WS               : 443, 2053, 2083       │"
    echo "    │   - Shadowsocks WS          : 443, 2053, 2083       │"
    echo "    │   - Shadowsocks None WS     : 80, 8080, 8880        |"
    echo "    │   - Shadowsocks gRPC        : 443, 2053, 2083       │"
    echo "    │   - Shadowsocks2022 WS      : 443, 2053, 2083       │"
    echo "    │   - Shadowsocks2022 NoNe WS : 80, 8080, 8880        |"
    echo "    │   - Shadowsocks2022 gRPC    : 443, 2053, 2083       │"
    echo "    │   - Socks5 WS               : 443, 2053, 2083       │"
    echo "    │   - Socks5 None             : 80, 8080, 8880        |"
    echo "    │   - Socks5 gRPC             : 443, 2053, 2083       │"
    echo "    │   - L2TP                    : 443, 2053, 2083       │"
    echo "    │   - PPTP                    : 443, 2053, 2083       │"  
    echo "    │   - SSTP                    : 443, 2053, 2083       │"
    echo "    │   - Shadowsocks R OBFS      : 443, 2053, 2083       │"
    echo "    │   - Shadowsocks R HTTP      : 443, 2053, 2083       │"
    echo "    │                                                     │"
